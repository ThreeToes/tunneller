...
func sendPublicKey(instance *ec2.Instance, user, publicKey string, client ec2instanceconnectiface.EC2InstanceConnectAPI) error {
	...
	if err != nil {
		if awsErr, ok := err.(awserr.Error); ok {
			if awsErr.Code() == ec2instanceconnect.ErrCodeThrottlingException {
...
func getEC2Instance(id string, client ec2iface.EC2API) (*ec2.Instance, error) {
